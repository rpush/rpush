...
describe Rpush::Daemon::Wpns::Delivery do
  ...
  let(:notification) { Rpush::Wpns::Notification.create!(app: app, data: { title: "MyApp", body: "Example notification", param: "/param1" }, uri: "http://some.example/", deliver_after: Time.zone.now) }
