...
if active_record?
  describe Rpush::Client::ActiveRecord::Apns::Notification do
    ...
    it "validates the length of the binary conversion of the notification" do
      ...
      expect(notification.errors[:base]).to include("APN notification cannot be larger than 2048 bytes. Try condensing your alert and device attributes.")
    end
    ...
    describe "multi_json usage" do
      describe "alert" do
        ...
        it "calls MultiJson.load when multi_json version is 1.3.0" do
        ...
        it "calls MultiJson.decode when multi_json version is 1.2.9" do
    ...
    it "defaults the sound to nil" do
