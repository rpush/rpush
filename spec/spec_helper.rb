...
require 'generators/templates/add_type_to_apps_and_notifications'

[CreateRapnsNotifications, CreateRapnsFeedback,
 AddAlertIsJsonToRapnsNotifications, AddAppToRapns, CreateRapnsApps, AddTypeToAppsAndNotifications].each do |migration|
